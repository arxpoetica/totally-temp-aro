...
app.service('tracker', ['$rootScope', ($rootScope) => {
  ...
  tracker.CATEGORIES = Object.freeze({
    ...
    ENTER_DEBUGGING_MODE: 'ENTER_DEBUGGING_MODE',
    ENTER_PLAN_SETTINGS_MODE: 'ENTER_PLAN_SETTINGS_MODE',

    VIEW_LOCATION_INFO: 'VIEW_LOCATION_INFO',
    VIEW_EQUIPMENT_INFO: 'VIEW_EQUIPMENT_INFO',
    VIEW_BOUNDARIES_INFO: 'VIEW_BOUNDARIES_INFO',
    VIEW_ROAD_SEGMENT_INFO: 'VIEW_ROAD_SEGMENT_INFO',
    VIEW_PLAN_INFO: 'VIEW_PLAN_INFO'
  })
