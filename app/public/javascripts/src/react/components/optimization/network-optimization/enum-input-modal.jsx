...
export const EnumInputModal = ({
  ...
  return (
    <Modal isOpen={isOpen} size="lg">
      <ModalHeader>
        Add{' '}
        {activeFilters[filterIndex] && activeFilters[filterIndex].displayName}{' '}
        Data
      </ModalHeader>
      <ModalBody>
        <h3>
          Copy &#38; Paste{' '}
          <span className="enum-input-subtitle">
            (separate by comma's ie 02066,02067,02068)
          </span>
        </h3>
        <TextArea
          value={text}
      ...
      <ModalFooter>
        <Button color="primary" onClick={() => saveText()}>
          Save
        </Button>
