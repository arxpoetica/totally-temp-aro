...
import MapLayerSelectors from '../../../components/map-layers/map-layer-reducer'
...
const PlanNavigation = props => {
  ...
  */
  ...
  console.log(tree)
  console.log( props.locations["household"] ) 
  let element = []
...
const mapStateToProps = state => {
  return {
    ...
    iconsByType: MapLayerSelectors.getEquipmentIcon(state),
  }
}
