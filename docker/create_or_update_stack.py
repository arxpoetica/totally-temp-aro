...
aro_data_private_image_name = os.environ.get('ARO_DATA_PRIVATE_IMAGE_NAME') or 'none'
aro_data_private_image_version = os.environ.get('ARO_DATA_PRIVATE_IMAGE_VERSION') or 'none'
...
def _set_environment():
    ...
    return [{ 'Key': 'app_container_tag', 'Value': str(build_num), 'Secure': False },
            ...
            { 'Key': 'aro_data_private_image_name', 'Value': str(aro_data_private_image_name), 'Secure': False },
            { 'Key': 'aro_etl_image_name', 'Value': str(aro_etl_image_name), 'Secure': False },
            { 'Key': 'aro_data_private_container_tag', 'Value': str(aro_data_private_image_version), 'Secure': False },
