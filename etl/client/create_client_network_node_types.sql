...
insert into client.network_node_types (name, description) values('fiber_distribution_hub','Fiber Deployment Hub') ;
insert into client.network_node_types (name, description) values('fiber_distribution_terminal','Fiber Deployment Terminal') ;
