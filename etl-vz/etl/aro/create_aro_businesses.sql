...
INSERT INTO aro.businesses(location_id, name, address, annual_recurring_cost, monthly_recurring_cost, source, geog, geom)
	SELECT
		l.id,
		b.nasp_nm,
...
-- Insert all TAMs
INSERT INTO aro.businesses(location_id, name, address, number_of_employees, source, geog, geom)
	SELECT
		l.id,
		b.business_nm,
		b.street_addr,
