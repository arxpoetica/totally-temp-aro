...
# Create ARO UOM table
${PSQL} -a -f $DIR/create_aro_uom.sql
...
# Create and load CMA boundaries
${PSQL} -a -f $DIR/create_aro_cma.sql
...
# Create aro.states table
${PSQL} -a -f $DIR/create_aro_states.sql