...
public class OptimizationTest {
    ...
    public void testFtth() throws IOException {
        try {
           ...
           // OptimizationInputs inputs = mapper.readValue(request, OptimizationInputs.class);
           // OptimizationResponse response = optimizationRestService.performOptimization(inputs);
