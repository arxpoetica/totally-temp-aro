...
public class FiberPlanRequestTypeIdResolver implements TypeIdResolver {
	...
	public void init(JavaType baseType) {
		...
		javaTypeByAlgorithm.put(FiberPlanAlgorithm.NPV, javaType(NpvFiberPlanImpl.class));
		javaTypeByAlgorithm.put(FiberPlanAlgorithm.CAPEX, javaType(CapexFiberPlanImpl.class));
	...
	public String idFromValue(Object value) {
		AbstractFiberPlan request = (AbstractFiberPlan) value;
