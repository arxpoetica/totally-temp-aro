...
@Embeddable
public class EquipmentSummaryCostKey implements Serializable {

	private int costCode;
	private long networkReportId;

	public EquipmentSummaryCostKey() {
	}

	public EquipmentSummaryCostKey(int costCode, long networkReportId) {
		super();
