...
public class NetworkDataDAO implements ComputeServiceApi, NetworkQueryService {
		...
		serviceAreaRoadEdges = computeUnitService
				...
				.setCacheLoaderFunc(
						(cacheQuery) -> () -> _getRoadEdges(cacheQuery
								...
								"serviceAreaContext", ServiceAreaContext.class))).build();
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#queryLocationDemand(boolean, java.util.Set, int, long, int, double, com.altvil.aro.service.network.ServiceAreaContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#queryRoadLocations(int, com.altvil.aro.service.network.ServiceAreaContext)
	 */
	@Override
	public ServiceAreaRoadLocations queryRoadLocations(int serviceAreaId,
			ServiceAreaContext ctx) {
		return serviceAreaRoadLocations.gridLoad(
				Priority.HIGH,
	...
	private ServiceAreaRoadLocations _queryRoadLocations(int serviceAreaId,
		...
		planRepository
				.queryAllLocationsByServiceAreaId(serviceAreaId, ctx.getStateCodes(),
						ctx.getFipsCodes())
				.stream()
				.map(OrdinalEntityFactory.FACTORY::createOrdinalEntity)
				.forEach(
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#queryFiberSources(long, com.altvil.aro.service.network.ServiceAreaContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#getRoadEdges(int, com.altvil.aro.service.network.ServiceAreaContext)
	 */
	@Override
	...
	private ServiceAreaRoadEdges _getRoadEdges(int serviceAreaId,
		...
		return new ServiceAreaRoadEdges(planRepository
				.queryRoadEdgesbyServiceAreaId(serviceAreaId, ctx.getFipsCodes())
				.stream()
				.map(OrdinalEntityFactory.FACTORY::createOrdinalEntity)
				.map(result -> {
					try {
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#selectedRoadLocationIds(long, java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#queryPlanConditEdges(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#queryExistingCableConduitEdges(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#getServiceAreaCodes(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.altvil.aro.service.network.impl.NetworkQueryService#getServiceAreaContext(java.lang.Integer)
	 */
	@Override
